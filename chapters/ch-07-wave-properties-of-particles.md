...
exports:
  ...
  - id: chapter-pdf
    ...
    output: ../exports/ch-07-wave-properties-of-particles.pdf
    chapter: 7
---
...
## Matter Waves: de Broglie and Experiment
...
:::{margin}
$h = 6.626\times10^{-34}\ \text{J}\cdot\text{s}$, the same constant from Chapter [6](#ch-particle-properties-of-waves)'s photon relations. It is often quoted instead as $\hbar \equiv h/2\pi = 1.055\times10^{-34}\ \text{J}\cdot\text{s}$, the form used later in this chapter for wave packets and the uncertainty principle.
:::
...
:::{seealso}
[*Is Anything Real?*](https://www.youtube.com/watch?v=L45Q1_psDqk) (Vsauce) pushes the same question further: even the "solidity" that lets your hand feel a table is a quantum effect, ultimately traceable to the Pauli exclusion principle ([Chapter 11](#ch-many-electron-atoms)) rather than to any classical picture of matter as tiny solid billiard balls.
:::
